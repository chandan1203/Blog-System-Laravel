                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <div class="info-box bg-pink hover-zoom-effect">
                            ...
                            <div class="content">
                                ...
                                <div class="number count-to" data-from="0" data-to="{{ $all_categories}}" data-speed="15" data-fresh-interval="20"></div>
                            </div>
                        </div>
                        ...
                        <div class="info-box bg-deep-purple hover-zoom-effect">
                            ...
                            <div class="content">
                                ...
                                <div class="number count-to" data-from="0" data-to="{{ $today_authors }}" data-speed="15" data-fresh-interval="20"></div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                     @if ($post->is_approved == true)
                                                        ...
                                                        <span class="label bg-green "><strong>Published</strong></span>
                                                            @else

                                                        <span class="label bg-red "><strong>Pending</strong></span>
                                                        @endif
                                                </td>
                                                <td>
                                                    <a class="btn btn-info" href="{{ route('admin.post.show',$post->id) }}">View</a>
                                                </td>
                                            </tr>
