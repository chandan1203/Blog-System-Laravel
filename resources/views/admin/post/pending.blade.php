...
@section('content')
        <div class="container-fluid">
            <div class="block-header">
                <a class="btn btn-primary" href="{{ route('admin.post.create') }}"><i class="material-icons">add</i>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    @if ($post->is_approved == false)
                                                        <button type="button" class="btn btn-success" onclick="pendingPost({{ $post->id }})">
                                                    ...
                                                    <a class="btn btn-info" href="{{ route('admin.post.edit',$post->id) }}"><i class="material-icons">edit</i></a>
