...
@section('content')
        <div class="container-fluid">
            <div class="block-header">
                <a class="btn btn-primary" href="{{ route('author.post.create') }}"><i class="material-icons">add</i>
                                        ...
                                        @foreach ($posts as $key => $post)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a class="btn btn-info" href="{{ route('author.post.edit',$post->id) }}"><i class="material-icons">edit</i></a>
