                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li>
                                ...
                                <a href="{{ Auth::user()->role->id == 1 ? route('admin.settings') : route('author.settings') }}"><i class="material-icons">person</i>Profile</a>
                            </li>
                            <li>
                ...
                <ul class="list">
                    ...
                    @if (Request::is('admin*'))
                        ...
                        <li class="{{ Request::is('admin/comments') ? 'active' : ''}}">
                            <a href="{{ route('admin.all.comments') }}">
                    ...
                    @if (Request::is('author*'))
                        ...
                        <li class="{{ Request::is('author/comments') ? 'active' : ''}}">
                            <a href="{{ route('author.all.comments') }}">
                                <i class="material-icons">comment</i>
                                <span>Comments</span>
                            </a>
                        </li>
