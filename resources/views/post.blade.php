...
@endsection
@push('css')
	<link href="{{ asset('assets/frontend/css/single_page/styles.css') }}" rel="stylesheet">

    <link href="{{ asset('assets/frontend/css/single_page/responsive.css') }}" rel="stylesheet">
                                ...
                                <ul class="post-footer">
                                    <li>
                                       @guest()
                                           ...
                                           ><i class="ion-heart">{{ $randompost->favourite_to_users->count()}}</i></a>
                                        @else
                                        <a href="#" onclick="document.getElementById('add-list-{{$randompost->id}}').submit()" class="{{ !Auth::user()->favourite_posts()->where('post_id',$randompost->id)->count()== 0 ? 'favorite_post' : ''}}" 
                                           ><i class="ion-heart">{{ $randompost->favourite_to_users->count()}}</i></a>
                                           <form id="add-list-{{$randompost->id}}" method="post" action="{{ route('add.favorite',$randompost->id) }}" style="display: none">
                                               @csrf
                                           </form>
			...
			<div class="row">
				...
				<div class="col-lg-8 col-md-12">
					...
					<div class="commnets-area ">
						...
						<a href="#">No Comment here...Be the First</a>
